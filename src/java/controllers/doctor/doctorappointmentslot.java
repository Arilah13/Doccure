 ...
 * @author rilah
 */
public class doctorappointmentslot extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int status = doctor.addslot(a);
            
            if(status == 1 ){     
                HttpSession session = request.getSession();
                session.setAttribute("add", "success");
                RequestDispatcher req = request.getRequestDispatcher("doctorappointments");
            ...
            Logger.getLogger(doctorappointmentslot.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
