 ...
 * @author rilah
 */
public class adminstaffchange extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int did = Integer.parseInt(request.getParameter("sid"));
        ...
        if(request.getParameter("change").equals("Edit"))
        {
            ...
            b.setDid(did);
            int c = a.updatestaff(b);
            if(c >0)
            {
                HttpSession session = request.getSession();
            session.setAttribute("update", "success");
                request.getRequestDispatcher("adminstaff").forward(request, response);
            }
            else
            {
                HttpSession session = request.getSession();
