 ...
 * @author rilah
 */
public class adminlabappointmentchange extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            try {
                if(a.deleteappointment(labid)){
                    HttpSession session = request.getSession();
                    session.setAttribute("fail", "out");
                    request.getRequestDispatcher("adminlabappointments").forward(request, response);
                }
            } catch (ParseException ex) {
                Logger.getLogger(adminlabappointmentchange.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
