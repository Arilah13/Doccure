								...
								<div class="card-body">
									<div class="success-cont">
										...
										<h3>Appointment booked Successfully!</h3>
                                                                                <p>Appointment booked for <strong><%=(String)(request.getAttribute("name"))%></strong><br> on <strong><%=(String)(request.getAttribute("date"))%> at <%=(String)(request.getAttribute("time"))%></strong><br><strong>Fee is Rs. <%=(String)(request.getAttribute("fee")) %></strong></p>
