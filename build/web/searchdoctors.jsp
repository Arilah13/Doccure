...
<head>
        ...
        <script type="text/javascript">
            var check = function() {
                var drname = document.myform.drname.value;
                var drspecial = document.myform.specialization.value;
                var drdate = document.myform.date.value;
                
                if( (drname.length==0) && (drspecial.length==0) && (drdate.length==0) )
                {
                    event.preventDefault();
                    swal({
                    title: "Fill atleast one field",
