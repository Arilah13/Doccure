																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<%=results.get(i).getTestname()%></a>
																		</h2>
																	</td>
																	<td class="text-left"><%=results.get(i).getTestdate()%><span class="d-block text-info"><%=results.get(i).getTesttime()%></span></td>
																	...
																	<td class="text-center"><span class="badge badge-pill bg-success-light">Confirm</span></td>
                                                                                                                                        <td class="text-center">
                                                                                                                                            
																		<div class="table-action">
                                                                                                                                                            <input name='uid' type = 'hidden' readonly value='<%=cookie%>'/>
																			    <input name='testid' type = 'hidden' readonly value='<%=results.get(i).getTestid()%>'/>
                                                                                                                                        ...
                                                                                                                                        <%
                                                                                                                                            ...
                                                                                                                                            {
                                                                                                                                         %>
                                                                                                                                         <td class="text-center">&nbsp;&nbsp;&nbsp;<span class="badge badge-pill badge-danger">Cancel</span></td>
			...
			<div class="modal fade" id="delete_modal">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">                                      
						<form action="labchange" method="POST">
						<div class="modal-body">
							<div class="form-content p-2">
								<h4 class="modal-title">Cancel</h4>
								<p class="mb-4">Are you sure want to cancel?</p>
                                                                <input name='uid' type = 'hidden' readonly value='<%=cookie%>'/>
                                                                <input name='testid' id='testid' type = 'hidden' readonly value=''/>
