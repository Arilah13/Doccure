						...
						<ul class="main-nav">
							...
							<li class="has-submenu">
								...
								<ul class="submenu">
									...
									<li><a href="doctor-profile.html">See Lab File</a></li>																
								</ul>
							</li>	
								...
								<div class="card-body">
									<div class="success-cont">
										...
										<h3>Appointment booked Successfully!</h3>
                                                                                <p>Appointment booked with <strong>Dr <%=(String)(request.getAttribute("drname"))%></strong><br> on <strong><%=(String)(request.getAttribute("date"))%> at <%=(String)(request.getAttribute("time"))%></strong><br><strong>Appointment No <%=(String)(request.getAttribute("appointmentid"))%></strong><br><strong>Price Rs. <%=(String)(request.getAttribute("fee"))%></strong></p>
										<a href="userhome.jsp" class="btn btn-primary view-inv-btn">Go Home</a>
									</div>
								</div>
							</div>
							<!-- /Success Card -->
