												...
												<tr>
													<td>
														<h2 class="table-avatar">
                                                                                                                    <a class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="assets/img/patients/<%=results.get(i).getPiccode1()%>.png" alt="Doctor Image"></a>
															<a><%=results.get(i).getUname()%></a>
														</h2>
													</td>
													<td><span class=""><%=results.get(i).getTestname()%></span></td>
                                                                                                        <%
                                                                                                            if(results.get(i).getDid()!=0)
                                                                                                                    {
                                                                                                        %>
													<td>
														<h2 class="table-avatar">
                                                                                                                    <a class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="assets/img/doctors/<%=results.get(i).getPiccode()%>.png" alt="User Image"></a>
															<a><%=results.get(i).getDrname()%> </a>
														</h2>
													</td>
                                                                                                        <%
                                                                                                            }
                                                                                                            else if(results.get(i).getDid() == 0)
                                                                                                            {
                                                                                                        %>
                                                                                                        <td></td>
                                                                                                        <%
                                                                                                        ...
                                                                                                        %>
													<td><%=results.get(i).getTestdate()%> <span class="text-primary d-block"><%=results.get(i).getTesttime()%></span></td>
                                                                                                        
                                                                                                        <%
                                                                                                                if(results.get(i).getStatus() == 0)
                                                                                                                {
                                                                                                                if(results.get(i).getSlot()==0)
                                                                                                                    {
                                                                                                        %>
                                                                                                        <td></td>
													<td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge badge-pill bg-warning-light inv-badge">Not Uploaded</span></td>
                                                                                                        <%
                                                                                                                    }
                                                                                                                else if(results.get(i).getSlot()==1)
                                                                                                                    {
                                                                                                        %>   
                                                                                                        <td>      
														...
														<div class="table-action" align="left">
                                                                                                        ...
                                                                                                        <td class="text-left">
                                                                                                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge badge-pill bg-success-light inv-badge">Uploaded</span>
                                                                                                        </td>                                                                                                                                        
                                                                                                        <%
                                                                                                                    }
                                                                                                                            }
                                                                                                        ...
                                                                                                        <td></td>
                                                                                                        <td >
                                                                                                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge badge-pill bg-danger-light inv-badge">Cancel</span>
                                                                                                        </td>
                                                                                                        <%
                                                                                                                }
                                                                                                         %>
                                                                                                       
                                                                                                        <input name='labid' type = 'hidden' readonly value='<%=results.get(i).getTestid()%>'/>
                                                                                                        <input name='uid' type = 'hidden' readonly value='<%=results.get(i).getUid()%>'/>
                                                                                                        <%
                                                                                                            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
                                                                                                            LocalDate Date = java.time.LocalDate.now();
                                                                                                            LocalDate Date2 = java.time.LocalDate.parse(results.get(i).getTestdate(), formatter);
													...
													<td class="text-center">
														<div class="actions">
															<a  data-toggle="modal" href="#delete_modal" id="<%=results.get(i).getTestid()%>" class="btn btn-sm bg-danger-light delete_data">
			...
			<div class="modal fade" id="delete_modal">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">                                      
						<form action="adminlabappointmentchange" method="POST">
						<div class="modal-body">
							<div class="form-content p-2">
								<h4 class="modal-title">Cancel</h4>
								<p class="mb-4">Are you sure want to cancel?</p>
                                                                
                                                                <input name='labid' id='paID' type = 'hidden' readonly value=''/>
