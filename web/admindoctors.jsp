    ...
    <body>
                                ...
                                %>
												...
												<tr>
													...
													<td><%=results.get(i).getDrspeciality()%></td>
                                                                                                        ...
                                                                                                        <td>Rs. <%=results.get(i).getEarnings()%></td>
													<%
													...
													<td class="text-center">
                                                                                                         ...
                                                                                                         <form action='admindoctorchange' method='post'>
                                                                                                        <td class="text-center">
														<div class="actions">
															<a data-toggle="modal" href="#edit_invoice_report" class="btn btn-sm bg-success-light mr-2 edit_data" id="<%=results.get(i).getDid()%>">
																<i class="fe fe-pencil"></i> Edit
															</a>
                                                                                                                    <button class="btn btn-sm bg-danger-light" type="submit" name="change" value="cancel">
																<i class="fe fe-trash"></i> Deactivate
															</button>
                                                                                                                                <input type = 'hidden' name='aid' readonly value='<%=results.get(i).getDid()%>'/>
														</div>
													</td>
                                                                                                        </form>
                                                                                                        <%
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											<label>Doctor Name</label>
                                                                                        <input name="drname" id="drname" type="text" class="form-control" value="">
										</div>
									</div>
                                                                    <%
               ...
               %>
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<select required name="drspeciality" id="speciality1" class="form-control">
                                                                                            <% while(rs.next()){ %>
                   ...
                   %>							
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" id="username1" name="druname" class="form-control" value="">
			...
			<div class="modal fade" id="Add_Specialities_details" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="doctorregister" method="POST" enctype="multipart/form-data">
                                                                <div class="row form-row">
									<div class="col-12 col-sm-6">
										<div class="form-group">
            ...
            try{
               ...
               %>
									<div class="col-12 col-sm-6">
										<div class="form-group">
											<label>Speciality</label>
                                                                                        <select required id="speciality" name="speciality" class="form-control">
               ...
               <%
                   ...
                   %>
                                                                ...
                                                                <div class="row form-row">
                                                                        ...
                                                                        <div class="col-12 col-sm-6">
										<div class="form-group">
											<label>Price per Appointment(in LKR)</label>
                            ...
                            $(document).on("click",".edit_data", function(){
                                ...
                                $.ajax({
                                    ...
                                    success: function(data){
                                        ...
                                        $("#speciality1").val(data.speciality);
                                        $("#aid").val(data.aid);
                                    }
                                });
                            });
       ...
       <%  
                ...
                if(session3 == "success")
                    {
                    swal({
                    title: "Doctor Deactivated Successfully",
                    //text: "You clicked the button!",
                    icon: "success",
                    button: "Ok"
                    });
                    ...
                    {
                    swal({
                    title: "Doctor Deactivate Unsuccessful",
                    //text: "You clicked the button!",
                    icon: "error",
                    button: "Ok"
                    });
