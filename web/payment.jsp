									...
									<div class="booking-summary">
										<div class="booking-item-wrap">
											...
											<ul class="booking-fee">
												<li>Consulting Fee <span>Rs <%=fee1%></span></li>
												<li>Booking Fee <span>Rs 1000</span></li>												
											</ul>
