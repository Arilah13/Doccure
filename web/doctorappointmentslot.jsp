                                    ...
                                    %>
																	...
																	<td><span class="badge badge-pill bg-success-light">Confirm</span></td>
																		...
																		<div class="table-action">
																			    ...
																			    <input name='aid' type = 'hidden' readonly value='<%=results.get(i).getAid()%>'/>
			...
			<div class="modal-dialog modal-dialog-centered" >
				<div class="modal-content" style="width: 750px;">
					...
					<div class="modal-body" style="width: 750px;">
						<form action="doctorappointmentslot" method="POST">
                                                    <div>
                                                            ...
                                                            <div class="col-12 col-md-10">
                                                                <div class="row form-row">
                                                                    ...
                                                                    <div class="col-12 col-md-4">
                                                                        <div class="form-group">                                                                          														
                                                                                <input type="text" id="slot" name="slot" class="form-control" placeholder="Enter Slot">	
			...
			<div class="modal-dialog modal-dialog-centered" >
				<div class="modal-content" style="width: 650px;">
					...
					<div class="modal-body" style="width: 650px;">
                                            <form action="doctorappointmentupdate" method="POST">
                                                    <div>
			...
			<div class="modal fade custom-modal" id="delete_modal">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">                                      
						<form action="doctorslotchange" method="POST">
