				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
                                                    <form action="specialityupdate" method="POST">
								<div class="row form-row">
									<div class="col-12 col-sm-12">
										<div class="form-group">
											<label>Specialities</label>
                                                                                        <input required name="special" type="text" class="form-control">
										</div>
									</div>
			...
			<div class="modal fade" id="edit_specialities_details" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
                                                    <form method="post" action="specialityupdate">
								<div class="row form-row">
	...
	<script>
        ...
        <%  
                ...
                if(session2 == "success")
                    ...
                    {
                    swal({
                    title: "Speciality Add Unsuccessful",
                    //text: "You clicked the button!",
                    icon: "error",
                    button: "Ok"
                    });
                ...
                if(session3 == "success")
                    ...
                    {
                    swal({
                    title: "Speciality Delete Unsuccessful",
                    //text: "You clicked the button!",
                    icon: "error",
                    button: "Ok"
                    });
